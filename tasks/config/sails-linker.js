  ...
  grunt.config.set('sails-linker', {
    ...
    prodJs: {
      options: {
        startTag: '<!--SCRIPTS-->',
        endTag: '<!--SCRIPTS END-->',
        fileTmpl: '<script src="/node/CompensacionElecciones%s?v=<%- (new Date()).getTime() %>"></script>',
        appRoot: '.tmp/public'
      },
      files: {
    ...
    prodStyles: {
      options: {
        startTag: '<!--STYLES-->',
        endTag: '<!--STYLES END-->',
        fileTmpl: '<link rel="stylesheet" href="/node/CompensacionElecciones%s?v=<%- (new Date()).getTime() %>">',
        appRoot: '.tmp/public'
      },
      files: {
